...
# Read data ----
setwd("/home/renansantos/Área de Trabalho/PD")
#setwd("/home/renansantos/Área de Trabalho/Online Algothim tests/OCLR-NSGA-II")
#setwd("/home/renansantos/Área de Trabalho/r100")
d1 <- read.csv("moead.csv",sep = ",", header = TRUE)
d2 <- read.csv("CL_NSGAII.csv",sep = ";", header = TRUE)
...
circos.track(
  ...
  panel.fun = function(x, y) {
    #circos.axis(labels.cex = 0.8, h = "bottom", lwd = 1)
    #circos.axis()
    #circos.text(0,1)
    #circos.text(CELL_META$xcenter, CELL_META$ycenter, CELL_META$sector.index, facing = "downward")
    circos.text(CELL_META$xcenter, CELL_META$cell.ylim[2] + uy(2, "mm"),paste("Obj. ", CELL_META$sector.index))
    circos.text(0, CELL_META$cell.ylim[2] + uy(0.5, "mm"),"0",cex = 0.5)
    circos.text(1, CELL_META$cell.ylim[2] + uy(0.5, "mm"),"1",cex = 0.5)
  },bg.col="red"
)
...
#legend(locator(1), legend=c("SPEA 2 - AT", "SPEA 2 - CL"), fill=c("blue", "#006400"), bty="n")
#legend(x=0.8, y=-1.0, legend=c("OCLR-NSGA-II", "ACLR-NSGA-II"), fill=c("blue", "#006400"), bty="n")
legend(x=0.8, y=-1.0, legend=c("MOEA-D", "CL-NSGA-II"), fill=c("blue", "#006400"), bty="n")
